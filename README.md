# Deploy Intrinsic Script

This package includes a CLI script for deploying the latest Intrinsic smart contracts to any EVM (Ethereum Virtual Machine) compatible network.
...
Options:
  ...
  -wrbtc, --wrbtc-address <address>            Address of the WRBTC contract on this chain
  -ncl, --native-currency-label <string>    Native currency label, e.g. RBTC
